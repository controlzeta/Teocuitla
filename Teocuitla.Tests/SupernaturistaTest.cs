...
namespace Teocuitla.Tests
{
    public class SupernaturistaTest
    {
        ...
        public void TestExtractionHeuristics_ExtractsExpectedValues()
        {
            ...
            var file1 = Directory.GetFiles(htmlDir, "supernaturista.com_*_16-41-57.html").FirstOrDefault() 
                        ?? Path.Combine(htmlDir, "supernaturista.com_2026-07-28_16-41-57.html");
            ...
            var file2 = Directory.GetFiles(htmlDir, "supernaturista.com_*_16-42-09.html").FirstOrDefault()
                        ?? Path.Combine(htmlDir, "supernaturista.com_2026-07-28_16-42-09.html");
